  ...
  return (
    ...
    <Head>
      ...
      <div className='absolute bottom-0 right-0 md:block hidden mr-10 mb-5'>
        <p>Open Source on <span className='hover:text-green-600'><a href='https://github.com/hellofaizan/discord' target="_blank" rel="noreferrer"><i class="bi bi-github"></i> Github</a></span></p>
        </div>
